        ...
        if (worksheet[`D${i}`] !== undefined && worksheet[`C${i}`] !== "") {  // 기준
            standardCompanyData.set(
                worksheet[`D${i}`].w, {
                    ...
                    publicOffering: worksheet[`I${i}`] !== undefined ? worksheet[`I${i}`].w : "",   // 기업공개
                    establishment: "",                      // 설립일
                    product: "",                            // 주요제품
                    state: "",
                    addrSiDo: "",
        ...
        if (worksheet[`J${i}`] !== undefined && worksheet[`K${i}`] !== undefined && worksheet[`J${i}`].w !== "") { //거래처
            standardCompanyData.set(
                worksheet[`J${i}`].w, {
                    ...
                    state: worksheet[`Y${i}`] !== undefined ? worksheet[`Y${i}`].w === "정상" ? "normal":"fail":"",
        ...
        if (worksheet[`AB${i}`] !== undefined && worksheet[`AC${i}`] !== undefined && worksheet[`AB${i}`].w !== "") { //구매처1
            standardCompanyData.set(
                worksheet[`AB${i}`].w, {
                    ...
                    corporationNum : "",
                    businessNum : "",
                    sales_2019: worksheet[`AG${i}`] !== undefined ? worksheet[`AG${i}`].w : "",
